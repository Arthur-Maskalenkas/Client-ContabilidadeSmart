...
const mock: BannerProps[] = [
  ...
  {
    img: 'img/index/Contabilidade-Rural-votuporanga-02-scaled.jpg',
    title: 'Sua empresa preparada ',
    subtitle: 'Venha fazer uma parceria de sucesso ingressando ao novo normal.',
    buttonLabel: 'Veja mais',
    buttonLink: '/',
    textDirection: 'right',
    titleImage: 'Uma familia sorrindo'
  }
]
